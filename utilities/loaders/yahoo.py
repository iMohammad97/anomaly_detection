...
def get_dataloaders(path: str, benchmark: int, data_id: int, window_size: int, batch_size: int, train_split: float = 0.5, step_size: int = 1, shuffle: bool = False, seed: int = 0):
